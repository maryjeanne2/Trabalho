...
<body>
    <header class="container text-center">
        <img src="img/avatar-perfil.png" alt="avatar da Mary jeanne" class="rounded-circle" width="150" height="150"
            srcset="">
        <p class="lead">Eu sou Mary Jeanne_</p>
        <h1>Eu estudo Programação</h1>
        <p>Sou Estudante do ensino médio e estudo programação!</p>
